...
export default function TalentBot({ user }) {
  ...
  const [messages, setMessages] = useState([
    {
      role: "assistant",
      content: "Bonjour ! Je suis TalentBot, votre assistant IA pour le recrutement. Je peux vous aider à optimiser vos processus, répondre à vos questions sur TalentLink, et vous accompagner dans vos missions de recrutement. Comment puis-je vous assister aujourd'hui ?",
  ...
  const startNewConversation = () => {
    ...
    setMessages([
      {
        role: "assistant",
        content: "Bonjour ! Je suis TalentBot, votre assistant IA pour le recrutement. Comment puis-je vous aider aujourd'hui ?",
        timestamp: new Date().toISOString()
      }
    ]);
    setShowConversationList(false);
